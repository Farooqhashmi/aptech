            ...
            <div class="bg-light rounded h-100 p-4">
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        id="exampleInputEmail1" value="<?php echo $proData['productName'] ?>" 
                    ...
                    <div class="form mb-3">
                        <select class="form-select" name="pCatid" aria-label="">
                            ...
                            <?php echo $proData['productcatId'] == $values['catId'] ? 'selected' : "" ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="emailHelp" name="productDescription" 
                        style="height: 150px;"><?php echo $proData['productDescription'] ?></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="Product Quantity" class="form-label">Product Quantity</label>
                        <input type="number" value="<?php echo $proData['productQuantity'] ?>" 
                        name="productQuantity" class="form-control" id="exampleInputEmail1" 
                        aria-describedby="emailHelp">
                        <div id="emailHelp" class="form-text"></div>
                    </div>
                    <div class="mb-3">
                        <label for="Product price" class="form-label">Product Price</label>
                        <input type="number" value="<?php echo $proData['productPrice'] ?>" 
                        name="productPrice" class="form-control" id="exampleInputEmail1" 
                        aria-describedby="emailHelp">
                        <div id="emailHelp" class="form-text"></div>
                    </div>
                    <div class="mb-3">
                        <label for="Product Img" class="form-label">Image</label>
                        <img src="<?php echo $productref . $proData['productImage'] ?>" 
                        alt="Product Image" style="max-width: 180px;">
